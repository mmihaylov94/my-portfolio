...
const sections: CaseStudySection[] = [
	...
	},
	{
		...
		paragraphs: [
			"Everything is built, tested, and deployed. It runs on AWS with staging and production environments, images built by GitHub Actions, a scripted deployment that snapshots the database before every migration, and a scripted rollback. Roughly 98,000 lines of production TypeScript sit behind a 92,000-line test suite with an 85% coverage gate in CI. The final legal review is complete. The site went live on 18 August 2026, and registrations opened on 2 September.",
