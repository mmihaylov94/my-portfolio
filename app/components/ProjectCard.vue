...
<template>
	<div
		class="relative bg-white dark:bg-gray-800 rounded-2xl shadow-lg overflow-hidden border border-gray-200 dark:border-gray-700 w-full flex flex-col lg:h-full"
	>
		<!-- Navigation Buttons -->
		<button
			@click="emit('prev')"
			class="absolute left-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm hidden lg:flex items-center justify-center text-gray-500 dark:text-gray-400 opacity-70 hover:opacity-100 hover:text-secondary-700 dark:hover:text-secondary-300 hover:bg-white dark:hover:bg-gray-800 hover:shadow-lg transition-all duration-300"
		...
		<button
			@click="emit('next')"
			class="absolute right-4 top-1/2 -translate-y-1/2 z-10 w-10 h-10 lg:w-12 lg:h-12 rounded-full bg-white/60 dark:bg-gray-900/60 backdrop-blur-sm hidden lg:flex items-center justify-center text-gray-500 dark:text-gray-400 opacity-70 hover:opacity-100 hover:text-secondary-700 dark:hover:text-secondary-300 hover:bg-white dark:hover:bg-gray-800 hover:shadow-lg transition-all duration-300"
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-0 lg:h-full">
			...
			>
				<div class="space-y-5">
					...
					<!-- Description -->
					<p class="text-lg text-gray-600 dark:text-gray-300 leading-relaxed text-justify">
						{{ project.description }}
					</p>
